...
import com.meuprojeto.projetospringbooth2.entities.Payment;
import com.meuprojeto.projetospringbooth2.entities.Product;
import com.meuprojeto.projetospringbooth2.entities.User;
import com.meuprojeto.projetospringbooth2.entities.enums.OrderStatus;
import com.meuprojeto.projetospringbooth2.repositories.CategoryRepository;
import com.meuprojeto.projetospringbooth2.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User u1 = new User(null, "maria", "Maria Silva", "maria@gmail.com", "999999999", "$2a$10$6X.68jJxABZKoiUVOjfP5e0APjitKbwaPDKwbD.63uKwFD3.7E2z6", false);
		User u2 = new User(null, "jose", "Jose Silva", "jose@gmail.com", "888888888", "$2a$10$6X.68jJxABZKoiUVOjfP5e0APjitKbwaPDKwbD.63uKwFD3.7E2z6", true);
